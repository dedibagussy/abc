                                      ...
                                      <div class="col-md-10">
                                            ...
                                            <div class="card-header bg-primary text-white">Produk</div>
                                                ...
                                                <div class="input-group mb-3"><br>
                                                    ...
                                                    <select class="form-select" id="inputGroupSelect01" name="id_pembayaran">
                                                        <option value=""></option>
                                                        <option value="1">Tiket</option>
...
mysqli_query($koneksi,"insert into produk values('','$id_kategori','$id_pembayaran','$nama','$harga')");
...
<div class="box"> 
  <table id="pengeluaran" border="1" cellspacing="0" class="table">
    ...
    <?php 
      ...
      LEFT JOIN pembayaran ON produk.id_pembayaran = pembayaran.id_pembayaran");
